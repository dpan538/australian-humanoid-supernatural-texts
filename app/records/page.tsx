...
export const metadata = archivePageMetadata({
  ...
  description:
    "Browse search-ready public-text records in AusFigures across supernatural humanoid narratives, apparitions, spirit-person accounts, giants, legends, encounters, and retellings.",
  path: "/records",
