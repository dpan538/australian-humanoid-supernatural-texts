...
QUERY_ALIASES = {
    "Alcoa Wetlands, WA": ["The Spectacles Wetlands, WA"],
    ...
    "Christmas Hills Reserve, TAS": ["Christmas Hills, TAS"],
    "Cooperbung, NSW": ["Cooperabung, NSW"],
    "Danger falls, NSW": ["Dangar Falls, NSW"],
    "Dufty’s Beach, VIC": ["Duffys Beach, VIC", "Duffys Beach No. 1, VIC"],
    "Dunoon Village, NSW": ["Dunoon, NSW"],
    "Enogerra Creek, QLD": ["Enoggera Creek, QLD"],
    "Forestry 1 hour from Canberra, ACT": ["Brindabella National Park, ACT", "Canberra, ACT"],
    "Gallangowen State Forest, QLD": ["Gallangowan State Forest, QLD"],
    "Goongerah Errinundra National Park, VIC": ["Errinundra National Park, VIC", "Goongerah, VIC"],
    "Harietville, VIC": ["Harrietville, VIC"],
    "Kalamundra, WA": ["Kalamunda, WA"],
    "Kinglake West and Eden Park, VIC": ["Kinglake West, VIC", "Eden Park, VIC"],
    "Ku-ring-gai National Park, NSW": ["Ku-ring-gai Chase National Park, NSW"],
    "McPherson Ranges, QLD": ["McPherson Range, QLD"],
    "Moore Park Beach. Bundaburg, QLD": ["Moore Park Beach, QLD", "Moore Park Beach, Bundaberg, QLD"],
    "Mount. Buller area, VIC": ["Mount Buller, VIC"],
    "Mount Tambourine, QLD": ["Tamborine Mountain, QLD"],
    "Mullundung State Forest, VIC": ["Mullungdung State Forest, VIC"],
    "Munmorah State Conservation Park, NSW": ["Munmorah State Conservation Area, NSW"],
    "Myhree, VIC": ["Myrrhee, VIC"],
    "Near Coramba, NSW": ["Coramba, NSW"],
    "Nightcap National Park – Whian Whian State Conservation Area, NSW": ["Whian Whian State Conservation Area, NSW", "Nightcap National Park, NSW"],
    "Nunimbah Valley, QLD": ["Numinbah Valley, QLD"],
    "Orberon, NSW": ["Oberon, NSW"],
    "Otways – Beauchamp Falls, VIC": ["Beauchamp Falls, VIC"],
    "Otways - Beauchamp Falls, VIC": ["Beauchamp Falls, VIC"],
    "Princess Highway / Warrnambool, VIC": ["Warrnambool, VIC"],
    "Talingbo, NSW": ["Talbingo, NSW"],
    "Tanima Desert, NT": ["Tanami Desert, NT"],
    "Tambarumba, NSW": ["Tumbarumba, NSW"],
    "Timsvale, NSW": ["Timmsvale, NSW"],
    "Watagans State Forest, NSW": ["Watagans National Park, NSW", "Watagan State Forest, NSW"],
    "West of Emu Plains, NSW": ["Emu Plains, NSW"],
    "West of Grafton, NSW": ["Grafton, NSW"],
    "Wongawallen, QLD": ["Wongawallan, QLD"],
    "Yambah Station": ["Yambah, NT"],
    "Yambah Station, NT": ["Yambah, NT"],
    "Yarrabilllba, QLD": ["Yarrabilba, QLD"],
}
