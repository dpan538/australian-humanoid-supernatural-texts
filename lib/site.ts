...
export const siteConfig = {
  ...
  searchTopics: [
    ...
    "Australian hairy man records",
    "Australian wild man reports",
    "Australian yahoo folklore",
    "Australian giant folklore",
    "Australian fairy public texts",
    "Australian supernatural newspapers",
    "Australian folklore primary sources",
    "Australian supernatural public domain texts",
    "Yowie records",
    "bunyip public texts",
