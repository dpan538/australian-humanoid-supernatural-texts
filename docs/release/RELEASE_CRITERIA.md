...
- `python3 scripts/validate_v2.py` passes or documented non-release-blocking warnings are accepted.
...
- Deployment URL works over HTTPS.
- Domain binding is verified.
